"""Interactive coincidence widget used for plotting 2D event distributions.
"""
...
class CoincWidget(QtWidgets.QWidget):
    """Interactive Qt widget for visualizing a 2D coincidence map."""
    ...
    def __init__(
        ...
        """Initialize the widget and build the histogram and projection views."""
        super().__init__()
...
def interactive(
    ...
    """Create the coincidence widget and run the Qt event loop.

    The function is kept here because it is the natural factory for the widget and
    is the actual API used by the analysis pages.
    """
